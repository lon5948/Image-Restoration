...
class LinearWarmupCosineAnnealingLR(_LRScheduler):
    ...
    .. warning::
        ...
        :class:`LinearWarmupCosineAnnealingLR` after each iteration
        as calling it after each epoch will keep the starting lr at
    ...
    .. warning::
        ...
        method for this scheduler instead of :func:`get_lr()`.
        Though this does not change the behavior of the scheduler,
        when passing epoch param to :func:`.step()`,
